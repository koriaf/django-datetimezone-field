...
from .widgets import (
    SplitTimeTimeZoneWidget,
    SplitHiddenTimeTimeZoneWidget,
...
__all = (
    ...
    "AdminSplitTimeTimeZoneField",
    "SplitDateTimeTimeZoneField",
    "AdminSplitDateTimeTimeZoneField",
)
    ...
    def compress(self, data_list):
        if data_list:
            ...
            if data_list[1] in self.empty_values:
                raise ValidationError(
                    self.error_messages["invalid_time_zone"], code="invalid_time_zone"
                )
